...
import { ShieldCheck, Activity, Settings, Lock, Check, Play, AlertTriangle, FileCode, Fingerprint } from 'lucide-react';
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#020408] text-white select-none flex flex-col relative font-sans overflow-x-hidden">
      <div className="absolute inset-0 pointer-events-none fixed" style={{background: 'radial-gradient(ellipse at 50% 0%, rgba(0,102,255,0.1) 0%, transparent 50%)'}}></div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-4 h-[600px] lg:h-auto lg:sticky lg:top-24">
             ...
             <div className="bg-[#0a0c10] border border-[#1f1f1f] rounded-lg p-4 select-none">
                ...
                <p className="text-[10px] text-gray-500 leading-relaxed">
                  ...
                  <br/><br/>
                  &copy; 2026 Vaultix Security. All rights reserved.
                </p>
             </div>
          </div>
      </main>
